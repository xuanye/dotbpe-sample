...
{
    public class APaperServiceImpl : APaperServiceBase
    {
        private readonly APaperRepository _apaperRepo;
        private readonly IClientProxy _proxy;

        public APaperServiceImpl(APaperRepository apaperRepo, IClientProxy proxy)
        {
        ...
        public override async Task<RpcResult<APaperRsp>> GetAPaperAsync(GetAPaperReq request)
        {
            ...
            var qpaperService = _proxy.GetClient<QPaperServiceClient>();
